...
(setq doom-font (font-spec :family "MonaspiceKr Nerd Font" :size 15)
      doom-variable-pitch-font (font-spec :family "MonaspiceKr Nerd Font" :size 15)
      doom-big-font (font-spec :family "MonaspiceKr Nerd Font" :size 24))
(after! doom-themes
